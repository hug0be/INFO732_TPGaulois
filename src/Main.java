...
public class Main {
    public static void main(String[] args) {
        ...
        Characteristic exemplixCharacteristics = new Strength(new Endurance(29), 10);
        Characteristic added = new Strength(10);
        Characteristic added2 = new Endurance(20);
        Characteristic added3 = new Endurance(new Strength(10), 20);
        System.out.println(exemplixCharacteristics);
        System.out.println(exemplixCharacteristics.add(added3));
